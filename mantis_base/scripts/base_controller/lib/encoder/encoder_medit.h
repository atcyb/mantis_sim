...
#ifndef mantis_ENCODER_H
#define mantis_ENCODER_H
...
namespace mantis
{
    ...
    public:
        ...
        /** \brief Construct a mantis::Encoder providing access to quadrature encoder ticks and angular joint velocity.
         * 
