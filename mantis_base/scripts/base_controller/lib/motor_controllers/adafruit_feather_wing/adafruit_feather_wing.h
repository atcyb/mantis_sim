...
namespace mantis {
    ...
    class AdafruitMotorController : public MotorControllerIntf<Adafruit_MotorShield>
    {
        public:
             ...
             * 
             * Specify the motor to control \p motor_num (use 3 or 4 for mantis).
             ...
             * the PCB.
             * 
             * \param motor_num Number of the motor to control (one of 1, 2, 3, 4). mantis uses motors 3 and 4.
