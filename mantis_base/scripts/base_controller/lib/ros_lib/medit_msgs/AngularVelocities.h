#ifndef _ROS_mantis_msgs_AngularVelocities_h
#define _ROS_mantis_msgs_AngularVelocities_h
...
namespace mantis_msgs
{
  ...
  class AngularVelocities : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "mantis_msgs/AngularVelocities"; };
