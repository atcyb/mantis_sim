#ifndef _ROS_mantis_msgs_WheelsCmdStamped_h
#define _ROS_mantis_msgs_WheelsCmdStamped_h
...
#include "mantis_msgs/WheelsCmd.h"
...
namespace mantis_msgs
{
  ...
  class WheelsCmdStamped : public ros::Msg
  {
    public:
      ...
      _header_type header;
      typedef mantis_msgs::WheelsCmd _wheels_cmd_type;
    ...
    virtual const char * getType() override { return "mantis_msgs/WheelsCmdStamped"; };
