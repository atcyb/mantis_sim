#ifndef _ROS_mantis_msgs_AngularVelocitiesStamped_h
#define _ROS_mantis_msgs_AngularVelocitiesStamped_h
...
namespace mantis_msgs
{
  ...
  class AngularVelocitiesStamped : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "mantis_msgs/AngularVelocitiesStamped"; };
