...
namespace mantis_base
{
    ...
    void PID::updateDynamicReconfig()
    {
        ...
        // Get starting values
        mantis_base::ParametersConfig config;
        config.f = f_;
    ...
    void PID::updateDynamicReconfig(mantis_base::ParametersConfig config)
    {
        // Make sure dynamic reconfigure is initialized
        if(!dynamic_reconfig_initialized_)
            return;
    ...
    void PID::dynamicReconfigCallback(mantis_base::ParametersConfig &config, uint32_t /*level*/)
    {
