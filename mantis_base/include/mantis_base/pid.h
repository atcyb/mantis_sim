...
#include <mantis_base/ParametersConfig.h>
...
namespace mantis_base
{
    ...
    public:
        ...
        void updateDynamicReconfig(mantis_base::ParametersConfig config);

        /**
         * \brief Update the PID parameters from dynamics reconfigure
         */
        void dynamicReconfigCallback(mantis_base::ParametersConfig &config, uint32_t /*level*/);
    ...
    private:
        ...
        typedef dynamic_reconfigure::Server<mantis_base::ParametersConfig> DynamicReconfigServer;
