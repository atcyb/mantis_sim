#ifndef mantis_HW_INTERFACE_H
#define mantis_HW_INTERFACE_H
...
#include <mantis_msgs/AngularVelocitiesStamped.h>
...
namespace mantis_base
{
    ...
    class mantisHWInterface : public hardware_interface::RobotHW
    {
    public:
        /**
         * \brief Constructor
         ...
         */
        mantisHWInterface(ros::NodeHandle &nh, urdf::Model *urdf_model = NULL);

        /** \brief Destructor */
        virtual ~mantisHWInterface() {}
    ...
    protected:
        ...
        void encoderTicksCallback(const mantis_msgs::EncodersStamped::ConstPtr& msg_encoders);
        ...
        // mantis directly calculates normalized angles from encoder ticks
        ...
        /** \brief mantis reports travel distance in metres, need radians for ros_control RobotHW */
        double linearToAngular(const double &distance) const;
        /** \brief RobotHW provides velocity command in rad/s, mantis needs m/s. */
        ...
        // The parameters are defined in mantis_base/config/base.yaml
        ...
        // This subscriber receives the encoder ticks in the custom mantis_msgs/Encoder message
        ...
        // This subscriber receives the measured angular wheel joint velocity in the custom mantis_msgs/AngularVelocitiesStamped message
    ...
    };  // class mantisHWInterface

}  // namespace

#endif // mantis_HW_INTERFACE_H
